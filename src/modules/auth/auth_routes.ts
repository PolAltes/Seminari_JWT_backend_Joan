...
import { registerCtrl, loginCtrl, googleAuthCtrl, googleAuthCallback, doRefreshTokenCtrl } from "../auth/auth_controller.js";
import { doRefreshToken } from './auth_service.js';
...
/**
  ...
  */
router.post("/auth/refresh", doRefreshTokenCtrl);
